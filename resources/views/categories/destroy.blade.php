<form method="POST" action="{{ $route }}" id="deleteForm{{ $category->id }}">
    @csrf
    @method('DELETE')
    <td>
        <button type="button" onclick="confirmDelete({{ $category->id }})" class="text-white bg-blue-700 hover:bg-blue-800
